...
import com.ddoddo.balllog.global.exception.AppleServerException;
...
import com.ddoddo.balllog.infra.model.ApplePublicKey;
import com.ddoddo.balllog.infra.model.ApplePublicKey.Key;
...
public class AppleService {
    ...
    public AppleAccountInfo getAppleAccountInfo(String idToken) {
        ...
        try {
            ...
            throw new AppleServerException(ErrorCode.APPLE_FAILED_TO_GET_PUBLIC_KEY);
        }
        ...
        try {
            ...
            throw new AppleServerException(ErrorCode.APPLE_FAILED_TO_GET_INFO);
        }
    }

    private String getAppleClientSecret() {
        Date expirationDate = Date.from(
                LocalDateTime.now().plusDays(100).atZone(ZoneId.systemDefault()).toInstant()
        );
